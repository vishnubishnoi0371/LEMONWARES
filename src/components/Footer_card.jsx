  ...
  return (
    <div>
      <div className="max-w-[1272px] px-3 mx-auto py-7 sm:py-[56px] overflow-hidden">
        ...
        >
          <p className="max-w-[900px]  text-center font-ff-pop font-semibold text-[40px] lg:text-[64px] lrading-[50px] lg:leading-[88px] text-[#2e2e2e] pt-8 lg:pt-[80px] pb-[20px] lg:pb-[40px]">
